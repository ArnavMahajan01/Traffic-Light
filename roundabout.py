...
WEST_RIGHT_TURN = curve_road(
    WEST_RIGHT, WEST, (WEST[0], WEST_RIGHT[1]), resolution=n)
SOUTH_RIGHT_TURN = curve_road(
    SOUTH_RIGHT, SOUTH, (SOUTH_RIGHT[0], SOUTH[1]), resolution=n)
EAST_RIGHT_TURN = curve_road(
    EAST_RIGHT, EAST, (EAST[0], EAST_RIGHT[1]), resolution=n)
NORTH_RIGHT_TURN = curve_road(
    NORTH_RIGHT, NORTH, (NORTH_RIGHT[0], NORTH[1]), resolution=n)
